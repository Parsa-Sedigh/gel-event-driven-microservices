...
/* @EnableKafka enables detection of @kafkaListener. You may skip using @EnableKafka because spring boot will automatically
 enable @KafkaListener. But for a spring app, you need to use this annotation.*/
@EnableKafka
@Configuration
